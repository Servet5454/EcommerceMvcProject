...
namespace ECommerceWithMVC.Migrations
{
    ...
    [Migration("20230411143557_mig_2")]
    partial class mig_2
    {
            ...
            modelBuilder.Entity("ECommerceWithMVC.Models.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            KayitTarih = new DateTime(2023, 4, 11, 17, 35, 57, 311, DateTimeKind.Local).AddTicks(636),
                            Phone = "1234567890",
                            Phone2 = "1234567890",
                            Sifre = "123456",
                            Soyad = "Soyad1"
                        ...
                        new
                        {
                            ...
                            KayitTarih = new DateTime(2023, 4, 11, 17, 35, 57, 311, DateTimeKind.Local).AddTicks(638),
                            Phone = "0987654321",
                            Phone2 = "1234567890",
                            Sifre = "654321",
                            Soyad = "Soyad2"
            ...
            modelBuilder.Entity("ECommerceWithMVC.Models.Entities.Kullanici", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            KayitTarihi = new DateTime(2023, 4, 11, 17, 35, 57, 311, DateTimeKind.Local).AddTicks(505),
                            Sifre1 = "123456",
                            Sifre2 = "123456",
                            Soyad = "Yılmaz",
                            TelNo = "5551112233"
                        ...
                        new
                        {
                            ...
                            KayitTarihi = new DateTime(2023, 4, 11, 17, 35, 57, 311, DateTimeKind.Local).AddTicks(520),
                            Sifre1 = "678900",
                            Sifre2 = "678900",
                            Soyad = "Kaya",
                            TelNo = "5554445566"
